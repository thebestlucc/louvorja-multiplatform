  ...
  return (
    <div className="flex items-center rounded-md border p-1 bg-muted/20 gap-1">
      <Tooltip>
        ...
        <TooltipContent>{t("favorites.title")}</TooltipContent>
      </Tooltip>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            aria-label={t("hymnal.listView")}
          >
            <ListIcon className="h-4 w-4" />
          </Button>
        </TooltipTrigger>
        <TooltipContent>{t("hymnal.listView")}</TooltipContent>
      </Tooltip>
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            aria-label={t("hymnal.gridView")}
          >
            <LayoutGrid className="h-4 w-4" />
          </Button>
        </TooltipTrigger>
        <TooltipContent>{t("hymnal.gridView")}</TooltipContent>
      </Tooltip>
    </div>
  );
}
