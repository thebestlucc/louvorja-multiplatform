...
!macro NSIS_HOOK_POSTINSTALL
  ...
  ; Tauri's app_data_dir() resolves to %APPDATA% (Roaming), NOT %LOCALAPPDATA%.
  CreateDirectory "$APPDATA\com.louvorja"
  ...
  nsExec::ExecToLog '"$INSTDIR\LouvorJA.exe" --build-bible --input "$INSTDIR\resources\bible" --output "$APPDATA\com.louvorja\bible.db"'
  Pop $0
  ${If} $0 != "0"
