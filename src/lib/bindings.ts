...
export type ScheduleDepartment = { id: number; code: string | null; namePt: string | null; nameEn: string | null; nameEs: string | null; icon: string; color: string; peoplePerDay: number; shuffleOnGenerate: boolean; groupDatesInPrint: boolean; repeatMembersInGroupedDates: boolean; description: string | null; sortOrder: number; isSystem: boolean; isActive: boolean; createdAt: string; updatedAt: string; members: ScheduleDepartmentMember[] }
export type ScheduleDepartmentInput = { id: number | null; code: string | null; namePt: string | null; nameEn: string | null; nameEs: string | null; icon: string; color: string; peoplePerDay: number; shuffleOnGenerate: boolean; groupDatesInPrint: boolean; repeatMembersInGroupedDates: boolean; description: string | null; sortOrder: number; isActive: boolean }
